...
public class MenuController extends BaseController {
    ...
    @FXML
    public TextField confMaxGen;
    @FXML
    public TextField confTimes;
    ...
    public ArrayList<Runnable> neatSimulation(ArrayList<NEATController> controller) {
        ...
        for (NEATController con : controller) {
            ...
            threads.add(makeNEATControlledGame(con, LEARNING_STEP_DELAY, displayWhileLearning.isSelected()));
    ...
    public NEATController makeNEATControlledGame(NEATController con, long delay, boolean visible) {
        ...
        Runnable r = () -> {
            try {
                ...
                game.setLocation(rnd.nextInt(100), 10);
                con.gm = gm[0];
                while (!game.gameOver) {
                    con.makeMove();
...
//        F.executor.shutdown();
    ...
    public void update() {
        ...
        try {
            ...
            pool.distinctSpecies = targetSpecies;
